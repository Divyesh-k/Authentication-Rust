...
lazy_static! {
    ...
    static ref ROLLER_FILEPATH_PATTERN: String  = configuration::get::<String>(&"logger.roller_filepath_pattern".to_string());
    static ref ROLLER_MAX_COUNT: u32 = configuration::get::<u32>(&"logger.roller_max_count".to_string()) as u32;
    static ref ROLLER_BASE_START: u32 = configuration::get::<u32>(&"logger.roller_base_start".to_string()) as u32;
    static ref ALL_LOG_FILE_PATH:String = configuration::get::<String>(&"logger.all_logs_common_file_path".to_string());
}
